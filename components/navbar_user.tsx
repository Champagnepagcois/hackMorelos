...
import LoginIcon from '@mui/icons-material/Login'; //salir
...
export default function MiniDrawer() {
  ...
  const handlerefresh = (ruta: string) => {
    setOpen(false);
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
          {rutas.map((ruta,index) => (
            <ListItem key={index} disablePadding sx={{ display: 'block' }} onClick={() => handlerefresh(ruta.link)}>
              <ListItemButton
                sx={{
                  minHeight: 48,
...
{/* añadir wallet */}
            {/* <ListItem
            disablePadding
            onClick={() => handlerefresh('./usuarios/addwallet')}
            sx={{ display: 'block' }}
            >
              ...
              >
                ...
                <ListItemText primary="Añadir wallet" sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>  */}
{/* logout */}
            <ListItem
